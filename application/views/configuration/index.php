...
<div class="container-fluid configuration" id="configuration">
   ...
   <div class="row">
      <div class="col-sm-6">
         <div class="card">
            <div class="card-body">
               <h5 class="card-title">Logotipo de tu empresa</h5>
               <?php if ($configuration->logo != "") : ?>
                  <div class="image-preview" style="background-image:url('<?= base_url('assets/uploads/' . $configuration->logo) ?>')"></div>
               <?php endif; ?>

               <form action="<?= site_url('configuration/updateLogo') ?>" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                     <label for="logo">Seleccione un logo</label>
